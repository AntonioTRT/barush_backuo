(function () {
  ...
  const GENERIC_RECOMMENDATIONS = {
    ...
    3: "Mensaje de Baruch: Gracias por darte un espacio para mirar algo nuevo, porque tambien eso habla de ti y de tus ganas de avanzar. Que nunca te falte la claridad para elegir lo que te da paz, la fuerza para soltar lo que pesa y la paciencia para confiar en tu propio proceso.",
    4: "Mensaje de Baruch: Hay personas que iluminan sin darse cuenta y dejan una sensacion bonita en cada lugar al que llegan. Si hoy estas leyendo esto, toma estas palabras como un recordatorio de que tu esfuerzo vale, tu presencia importa y tu historia todavia tiene paginas muy bonitas por escribir.",
    5: "Mensaje de Baruch: No todo lo importante hace ruido; muchas veces lo mejor llega en silencio, mientras trabajas, descansas o simplemente decides no rendirte. Que la vida te sorprenda con respuestas serenas, encuentros honestos y motivos suficientes para sonreir con el corazon tranquilo.",
    6: "Mensaje de Baruch: Este espacio tambien puede servir para regalarte una idea bonita: mereces avanzar sin compararte con el ritmo de nadie. Tus tiempos son tuyos, tus batallas tambien, y aun asi sigues aqui, haciendo lo posible con dignidad, con fe y con una constancia que tarde o temprano dara fruto.",
    7: "Mensaje de Baruch: A veces una frase sencilla acompana mas de lo que imaginamos, por eso quiero dejarte esta: sigue confiando en lo que estas sembrando aunque todavia no lo veas florecer. Las etapas lentas no son etapas perdidas; muchas veces son las que preparan lo mejor que viene despues.",
    ...
    16: "Mensaje de Baruch: Hay temporadas para acelerar y temporadas para respirar, y ambas son necesarias. Si hoy te toca reorganizarte, descansar o empezar de nuevo, hazlo sin culpa; tambien eso es avanzar, porque una vida bien construida no solo se mide por velocidad, sino por equilibrio y sentido.",
    17: "Mensaje de Baruch: Nunca pienses que es poca cosa elegir un momento para ti, detenerte y leer unas palabras con calma. A veces esa pausa breve recuerda lo esencial: que sigues siendo capaz, que sigues teniendo valor y que todavia puedes abrir nuevas puertas aunque el panorama no este completo.",
    18: "Mensaje de Baruch: Que lo bueno te encuentre preparado, pero sobre todo en paz. No todo depende de controlar cada detalle; muchas cosas mejoran cuando sueltas la ansiedad, haces tu parte con honestidad y permites que el tiempo acomode aquello que ahora mismo parece no tener respuesta.",
    19: "Mensaje de Baruch: Hay dias en los que el corazon pide certeza y solo recibe silencio, pero incluso ese silencio puede estar trabajando a tu favor. Sigue sembrando con paciencia, sigue cuidando lo que amas y sigue creyendo que una etapa mas noble puede abrirse cuando menos te lo imagines.",
    20: "Mensaje de Baruch: Si llegaste hasta aqui, recibe este mensaje como una compania sencilla y sincera. Que no te falten motivos para confiar en ti, personas para compartir lo bueno y claridad para reconocer aquello que si te hace bien, porque mereces una vida construida con paz, verdad y esperanza."
  };
